...
* Installation
  ...
  The instructions below use git for the installation. Even though it is a bit more involved at first, it allows for convenient updates later, and you can even contribute to the development later. 

  Install [[https://git-scm.com][git]] (if you have not done already).

  Also, you should register at [[https://github.com][GitHub]].
...
** Updating your software
   ...
   You can update your software later on the terminal in the following way.
...
#+end_src  
  ...
  Now, the real fun starts when you combine multiple fenvs by other functions. For example, how about adding fenvs. That way, we can easily generate pretty complex envelopes with very good control over the final shape. 
...
#+end_src  
  ...
  The [[./doc/index.html][documentation]] briefly explains the various functions. There are also more examples in this [[./tests/test-fenv.lisp][test file]].
